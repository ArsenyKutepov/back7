    ...
    <div id="main" class="container-fluid container-md">
        <div class="row m-1 p-1 justify-content-center">
            <div class="col-sm-4">
                ...
                <div id="db_del_input" class="col m-1 p-1 rounded-3 border border-dark" style="background-color:#DC143C;">
                ...
                <div id="db_del_input" class="col m-2 p-2 rounded-3 border border-dark" style="background-color:#DC143C;">
                ...
                <div id="statistic" class="rounded-3 border border-dark" style="background-color:#DC143C;">
