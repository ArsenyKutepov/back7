    ...
    <div class="container-fluid container-md">
        <div class="row m-1 p-1 justify-content-center">
            <div class="col-sm-4">
                <div id="navbar">
                    <nav class="navbar navbar-dark bg-dark">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./login.php" style="color: white;">Loginin</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div id="forma" class="col m-1 p-1 rounded-3 border border-dark d-flex justify-content-center text-center" style="background-color:#DC143C;">
